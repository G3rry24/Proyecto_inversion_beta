...
#-------------------------------------------------------------------------------
# 1. CONFIGURACIÓN Y ESTILOS CSS (Para botones compactos)
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
# 2. SIDEBAR: WATCHLIST ULTRA-COMPACTA (2 COLUMNAS)
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
# 3. CUERPO PRINCIPAL: PERIODOS -> MÉTRICAS -> GRÁFICA
#-------------------------------------------------------------------------------
...
if not datos.empty and len(datos) > 1:
    ...
    st.download_button("📥 Descargar Datos CSV", datos.to_csv().encode('utf-8'), file_name, "text/csv")

else:
    st.error("No se pudieron obtener datos para este activo o periodo.")
